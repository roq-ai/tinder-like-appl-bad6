...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Tinder like application`}</title>

        <meta
          name="description"
          content="Experience a world of romance with Tinder like application, your gateway to building meaningful connections in the world of dating."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1575390130709-7b5fee2919e4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxkYXRpbmd8ZW58MHx8fHwxNjk1NDk0NDk4fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience a world of romance with Tinder like application, your gateway to building meaningful connections in the world of dating.`}
            </Text>
            <Box
